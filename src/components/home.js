    ...
    return (
      <div>
        <Jumbotron className="home">
          ...
          <h4 style="border: 1px solid red;">Hurwitz & Gantz, P.C. is committed to unwavering service of your legal needs during the COVID-19 pandemic. We have developed creative, flexible procedures to take care of clients, while keeping everyone safe and well. We are here for you.</h4>
        </Jumbotron>
